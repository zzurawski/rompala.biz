      ...
      <span className="logos">
        ...
        <div className="card">
          ...
          <div className="card__face card__face--back">
            <p className="clickhere">Click here to learn more about our Social Media marketing service</p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card__face card__face--back">
            <p className="clickhere">Click here to learn more about our Video/Photo service</p>
          </div>
        ...
        <div className="card">
          ...
          <div className="card__face card__face--back">
            <p className="clickhere">Click here to learn more about our Web Design service</p>
          </div>
        </div>
